                ...
                <div className="container">
                    ...
                    <div className="row mb-3" id="skills">
                        <div className="col-md-4 mx-auto">
                            <i className="fas fa-code text-black-50 wow fade-in-down"></i>
                        </div>
                        <div className="col-md-4 mx-auto">
                            <i className="fas fa-paint-brush text-black-50 wow fade-in-down"></i>
                        </div>
                        <div className="col-md-4 mx-auto">
                            <i className="fas fa-snowboarding text-black-50 wow fade-in-down"></i>
                        </div>
                    </div>
                </div>
            </section>
